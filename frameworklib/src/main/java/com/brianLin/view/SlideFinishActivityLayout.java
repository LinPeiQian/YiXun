...
/**
 * Created by Jensen on 2016/6/15.
 */
public class SlideFinishActivityLayout extends FrameLayout {

    private static final String TAG = SlideFinishActivityLayout.class.getSimpleName();
    ...
    public SlideFinishActivityLayout(Context context, AttributeSet attrs, int defStyle) {
